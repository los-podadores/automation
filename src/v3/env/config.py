...
PHASES: dict[int, dict[str, Any]] = {
    ...
    2: {"radii": (6.0, 8.0), "obst": (2, 3), "obs_rad": (0.5, 1.0), "max_steps": 3500},
    3: {"radii": (8.0, 9.5), "obst": (2, 3), "obs_rad": (0.7, 1.5), "max_steps": 3500},
    4: {"radii": (9.5, 11.0), "obst": (3, 4), "obs_rad": (0.8, 2.0), "max_steps": 3500},
    5: {
        "radii": (11.0, 13.0),
        "obst": (4, 5),
        "obs_rad": (1.0, 2.5),
